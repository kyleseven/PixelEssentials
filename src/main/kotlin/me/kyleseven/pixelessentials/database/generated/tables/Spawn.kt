...
open class Spawn(
     ...
     */
    val SPAWN_ID: TableField<SpawnRecord, Long?> = createField(DSL.name("spawn_id"), SQLDataType.BIGINT, this, "", AutoConverter<Long, Long>(java.lang.Long::class.java as Class<Long?>, Long::class.java))
     ...
     */
    val PITCH: TableField<SpawnRecord, Double?> = createField(DSL.name("pitch"), SQLDataType.DOUBLE.nullable(false), this, "")

    /**
     * The column <code>spawn.yaw</code>.
     */
    val YAW: TableField<SpawnRecord, Double?> = createField(DSL.name("yaw"), SQLDataType.DOUBLE.nullable(false), this, "")

    /**
     * The column <code>spawn.world</code>.
     */
    val WORLD: TableField<SpawnRecord, String?> = createField(DSL.name("world"), SQLDataType.CLOB.nullable(false), this, "")

    private constructor(alias: Name, aliased: Table<SpawnRecord>?): this(alias, null, null, null, aliased, null, null)
    private constructor(alias: Name, aliased: Table<SpawnRecord>?, parameters: Array<Field<*>?>?): this(alias, null, null, null, aliased, parameters, null)
    private constructor(alias: Name, aliased: Table<SpawnRecord>?, where: Condition?): this(alias, null, null, null, aliased, null, where)
     ...
     */
    override fun where(condition: Condition?): Spawn = Spawn(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(condition: SQL): Spawn = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): Spawn = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): Spawn = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): Spawn = where(DSL.condition(condition, *parts))

    /**
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): Spawn = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): Spawn = where(DSL.notExists(select))
}
