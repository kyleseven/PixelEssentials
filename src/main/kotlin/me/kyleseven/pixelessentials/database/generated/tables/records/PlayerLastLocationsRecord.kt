 ...
 */
@Suppress("warnings")
open class PlayerLastLocationsRecord private constructor() : UpdatableRecordImpl<PlayerLastLocationsRecord>(PlayerLastLocations.PLAYER_LAST_LOCATIONS) {
     ...
     */
    constructor(playerId: Long? = null, x: Double, y: Double, z: Double, pitch: Double, yaw: Double, world: String): this() {
