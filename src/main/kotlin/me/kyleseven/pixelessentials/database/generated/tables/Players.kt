...
open class Players(
     ...
     */
    val PLAYER_ID: TableField<PlayersRecord, Long?> = createField(DSL.name("player_id"), SQLDataType.BIGINT, this, "", AutoConverter<Long, Long>(java.lang.Long::class.java as Class<Long?>, Long::class.java))

    /**
     * The column <code>players.last_account_name</code>.
     */
    val LAST_ACCOUNT_NAME: TableField<PlayersRecord, String?> = createField(DSL.name("last_account_name"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>players.uuid</code>.
     */
    val UUID: TableField<PlayersRecord, String?> = createField(DSL.name("uuid"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>players.ip_address</code>.
     */
    val IP_ADDRESS: TableField<PlayersRecord, String?> = createField(DSL.name("ip_address"), SQLDataType.CLOB.nullable(false), this, "")

    /**
     * The column <code>players.first_join</code>.
     */
    val FIRST_JOIN: TableField<PlayersRecord, Long?> = createField(DSL.name("first_join"), SQLDataType.BIGINT.nullable(false), this, "")

    /**
     * The column <code>players.last_seen</code>.
     */
    val LAST_SEEN: TableField<PlayersRecord, Long?> = createField(DSL.name("last_seen"), SQLDataType.BIGINT.nullable(false), this, "")

    /**
     * The column <code>players.total_playtime</code>.
     */
    val TOTAL_PLAYTIME: TableField<PlayersRecord, Long?> = createField(DSL.name("total_playtime"), SQLDataType.BIGINT.nullable(false), this, "")
    ...
    fun playerLastLocations(): PlayerLastLocationsPath {
        if (!this::_playerLastLocations.isInitialized)
            _playerLastLocations = PlayerLastLocationsPath(this, null, PLAYER_LAST_LOCATIONS__FK_PLAYER_LAST_LOCATIONS_PK_PLAYERS.inverseKey)
     ...
     */
    override fun where(condition: Condition?): Players = Players(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): Players = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): Players = where(DSL.notExists(select))
}
