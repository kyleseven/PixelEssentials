 ...
 */
@Suppress("warnings")
open class SpawnRecord private constructor() : UpdatableRecordImpl<SpawnRecord>(Spawn.SPAWN) {

    open var spawnId: Long?
     ...
     */
    constructor(spawnId: Long? = null, x: Double, y: Double, z: Double, pitch: Double, yaw: Double, world: String): this() {
